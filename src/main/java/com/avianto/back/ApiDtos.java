...
public final class ApiDtos {
  ...
  public record CircuitChangeRequest(@NotBlank String seccion, @NotBlank @Size(max=500) String motivo) {}
  ...
  public record VentaFichaResponse(UUID id, String numero, UUID motoId, String patente, String moto, UUID vendedorId, String vendedor, UUID compradorId, String comprador, String estado, boolean obligatoriosCompletos, Instant finalizadaAt, String finalizadaPor, Instant canceladaAt, String canceladaPor, String canceladaMotivo, List<VentaFichaItemResponse> items, VentaTransferenciaResponse transferencia, Instant creadaEn, Instant actualizadaEn) {}
  ...
  public record RepuestoItemRequest(@NotBlank String descripcion, @NotNull RepuestoCategoria tipo, UUID fichaTrabajoId, @NotNull @Positive @Digits(integer=12,fraction=2) BigDecimal cantidad, @NotNull @DecimalMin("0.00") @Digits(integer=12,fraction=2) BigDecimal precio, String estado, String observaciones, UUID id) {
