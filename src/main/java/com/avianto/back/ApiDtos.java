...
public final class ApiDtos {
  ...
  public record MotorcycleResponse(UUID id, UUID clienteId, UUID marcaId, String cliente, String marca, String modelo, String patente, Integer anio, Integer kilometraje, String observaciones, boolean activo, Instant createdAt, Instant updatedAt) {}
  ...
  public record OrderItemRequest(UUID itemCatalogoId, @NotBlank String descripcion, @NotNull ItemType tipo, @NotNull @Positive @Digits(integer=12,fraction=0) BigDecimal cantidad, @NotNull @DecimalMin("0.00") BigDecimal precioUnitario, @NotNull @DecimalMin("0.00") BigDecimal descuento) {}
